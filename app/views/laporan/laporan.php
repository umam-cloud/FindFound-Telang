<main class="max-w-4xl mx-auto px-6 py-10 md:py-14">
    ...
    <form action="<?=BASEURL?>/laporan/addLaporan" method="POST" enctype="multipart/form-data">
        ...
        <div class="relative w-full h-56 md:h-72 rounded-[2rem] overflow-hidden mb-10 group cursor-pointer border border-gray-100 shadow-sm bg-gray-100">
            <img id="preview_foto" src="https://images.unsplash.com/photo-1627123424574-724758594e93?q=80&w=800" alt="Upload Background" class="absolute inset-0 w-full h-full object-cover opacity-40 mix-blend-multiply blur-sm group-hover:scale-105 transition-transform duration-700">
